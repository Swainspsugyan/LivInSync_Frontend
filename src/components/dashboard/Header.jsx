...
export default function Header({ session, onMenu, onSignOut, profile, setProfile }) {
  const { t } = useI18n()
  return (
    <header className="sticky top-0 z-20 flex min-w-0 items-center gap-2 border-b border-white/25 bg-transparent px-3 py-3 backdrop-blur-[2px] transition-colors duration-300 dark:border-white/10 dark:bg-[#0b1b2b]/90 sm:gap-3 sm:px-6">
      <button
        type="button"
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button
          type="button"
          className="relative rounded-lg border border-slate-200 bg-[#fafafa] p-2 text-slate-600 hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-slate-200 bg-[#fafafa] py-1 pl-1 pr-2 text-slate-800 hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
          >
          ...
          {profile && (
            <div className="absolute right-0 mt-2 w-44 rounded-xl border border-slate-200 bg-[#fafafa] p-1 shadow-lg dark:border-white/10 dark:bg-[#0b1b2b]">
              <button
                type="button"
                onClick={onSignOut}
